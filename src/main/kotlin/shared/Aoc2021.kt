...
abstract class Aoc2021(private val debug: Boolean = true) {
    ...
    private val identifier: String by lazy { this::class.simpleName.toString().lowercase() }
    ...
    private fun inputReader(fileName: String) = File("src/main/kotlin/$identifier", fileName).inputStream().reader()

    fun debug(forceDebug: Boolean = false, message: () -> Any) {
    ...
    private fun runPart(
        ...
        measureTimeMillis {
            ...
            println("$runOrTest $identifier part $partNo using '$inputFileName' ...")
